...
# For people who died, we need to censor them at the earliest of their date of death and overall censoring (e.g. a participant with an IHD event in Wales in 2019 and who died # in 2020 should nonetheless be censored at 28.02.2018
...
IHD_group <- dAll[(dAll$ischaemic.heart.disease.incident == 1), ]
dAll$follow_up[(dAll$ischaemic.heart.disease.incident == 1)] <-  pmin(as.Date(IHD_group$ischaemic.heart.disease, format = "%Y-%m-%d"), IHD_group$censoring)
