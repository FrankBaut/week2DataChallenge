...
- `dataset-partially-processed`: A partially processed dataset, for illustrative purposes.
...
We will make use of a repo that Shing and Rosemary have developed for this purpose. [Read the docs](https://ukb-download-and-prep-template.readthedocs.io/en/latest/started.html) and [find it on GitHub]( https://ukb-download-and-prep-template.readthedocs.io/en/latest/download.html#downloading-participant-data). It uses Python scripts. To ensure you have the appropriate dependencies, you need to run 
```{r, engine='bash', eval = FALSE}
conda activate wearables
```
If you later want to  use RMardown, you might have to run: `conda deactivate`. 
