...
Note that this describes working with Hospital Episode Statistics (`hesin_all.csv`). You will probably also want to use data on deaths, which can be found in the `death.txt` and `death_cause.txt` files. 
